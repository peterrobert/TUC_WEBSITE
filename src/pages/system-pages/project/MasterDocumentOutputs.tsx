      ...
      <div className="max-w-7xl mx-auto px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-medium-gray max-w-3xl mx-auto">
            Comprehensive suite of professional business documents automatically
            generated from project input data.
          </p>
        </div>
        <div className="grid grid-cols-5 gap-4">
          ...
          >
            ...
            <h4 className="font-semibold text-dark-gray text-sm">RFP / RFQ</h4>
          </div>
          <div
            id="doc-whitepaper"
            className="bg-white rounded-lg p-5 border border-cool-gray hover:border-deep-blue hover:shadow-lg transition-all group"
...
export default MasterDocumentOutputs;
