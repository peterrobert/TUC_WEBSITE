    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <div className="border-l-4 border-deep-blue pl-8 py-6 my-12">
          ...
          <p className="text-2xl font-serif text-dark-gray leading-relaxed italic">
            What’s missing is a reliable way to coordinate effort so useful work
            doesn’t stall, duplicate, or disappear.
          </p>
          <p className="text-2xl font-serif text-dark-gray leading-relaxed italic">
                  ...
                  <div id="impact-section">
                    <ul className="space-y-4">
                      ...
                      <li className="flex items-start">
                        <i className="fa-solid fa-circle text-red-400 text-xs mt-2 mr-3"></i>
                        <span className="text-text-secondary">
                          It transforms "Someone should do something" into "Here
                          is what is happening, who is involved, and what comes
                          next."
                        </span>
                      </li>
